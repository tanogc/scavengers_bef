#################################################################################################################################
## quality_funct_space: R function for computing the quality of functional multidimensional functional spaces                  ##
##                                                                                                                             ##
...
##                                                                                                                             ##
##                                                                                                                             ##
##  Code modified and adapted by Cayetano Gutiérrez-Cánovas (GutierrezCanovasC@cardiff.ac.uk)                                  ##
##                                                                                                                             ##
##                                                                                                                             ##
##     INPUTS:                                                                                                                 ##
##                                                                                                                             ##
...
##                                                                                                                             ##
##      - $ fpc : coordinates of species in the nbdim multidimensional functional space (PCoA)                                 ##
##                                                                                                                             ##
##                                                                                                                             ##
##                                                                                                                             ##
#################################################################################################################################

quality_funct_space <- function(mat_funct, nbdim=7, metric="Gower",corr_method=c("none","cailliez","lingoes")) {
...
# checking data
if (sum(is.na(mat_funct))!=0)   {  warning(" NA detected in 'funct_mat' ")     }
...
if (metric=="Gower") mat_dissim<-gowdis(mat_funct,ord="classic")
if (metric=="Euclidean") mat_dissim<-dist(scale(mat_funct)) # scaling if continuous traits
...
mat_pcoa<-pcoa(mat_dissim , correction=corr_method)
